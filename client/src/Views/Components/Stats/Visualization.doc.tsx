...
const boulderStats = [
  ...
  },
  {
    ...
    removedOn: null,
    setters: ["NTTqDn8wIo98F95q4ehYPdgXL0H20H9mMbPkpYg5m9"],
    sector: "spektrumthree",
    grade: "blue"
  },
  {
    setOn: "2017-12-26",
    removedOn: "2017-12-30",
    setters: ["NTTqDn8wIo98F95q4ehYPdgXL0H20H9mMbPkpYg5m9"],
    sector: "spektrumone",
    grade: "blue"
  },
...
${(
  <ReactSpecimen noSource>
    <div style={{ height: 800, display: "flex" }}>
      <Visualization bssC={Computation.pure(toEvents(boulderStats))} sectors={[]} selectedSetters={[]} />
    </div>
  </ReactSpecimen>
)}
`;
